...
DynamixelInterface::DynamixelInterface(HardwareSerial &aStream, uint8_t aDirectionPin, bool aTranferOwnership) :
...
void DynamixelInterface::begin(unsigned long aBaud)
{
	mStream.begin(aBaud);
