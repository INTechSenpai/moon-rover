...
class HookAbscisseGauche extends Hook {

    private float abscisse;
    
    public HookAbscisseGauche(Read_Ini config, Log log, GameState<RobotVrai> real_state, float abscisse, boolean effectuer_symetrie)
    {
